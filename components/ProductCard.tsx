...
export default function ProductCard({ p }: { p: Product }) {
  ...
  /* Bouton « Ajouter » sur lequel la bulle d'options vient s'ancrer */
  ...
  /* « Ajouter » ouvre la bulle de propositions (accompagnement,
     sauce, boisson, pièce en plus) ancrée sur le bouton cliqué. */
  ...
  return (
    <>
      ...
      {/* Bulle rendue hors de la carte : .p-card porte un backdrop-filter
          qui deviendrait le bloc de contenance d'un enfant positionné
          en fixed et la coincerait à l'intérieur de la carte */}
      {anchor && <AddOptions product={p} anchor={anchor} onClose={() => setAnchor(null)} />}
    </>
  );
}
